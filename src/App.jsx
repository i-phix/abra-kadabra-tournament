...
@media (max-width: 640px) {
  ...
  .page-wide { padding: 20px 12px 48px; }

  h1 { font-size: 21px; }
  .subtitle { font-size: 13px; margin-bottom: 28px; }

  /* ── GROUP GRID → single column ── */
  .group-grid {
  ...
  /* ── PICKS SUMMARY ── */
  .picks-summary { padding: 12px 14px; }
  .pick-chip, .pick-chip-empty {
    height: 28px;
    padding: 0 10px;
    font-size: 12px;
  }
  ...
  .rank-cell { font-size: 12px; }
  .team-cell { font-size: 11px; max-width: 90px; }
  ...
  /* ── ADMIN TEAMS GRID → single column ── */
  .admin-teams-grid {
    grid-template-columns: 1fr;
    gap: 10px;
  }

  /* ── KNOCKOUT GRID → single column ── */
  .knockout-grid {
    grid-template-columns: 1fr;
    gap: 2px;
  }
  ...
  /* ── WDL BUTTONS ── */
  .wdl-btn { height: 34px; font-size: 12px; }
  .wdl-match-label { font-size: 11px; width: 40px; }
  ...
  /* ── ADMIN PLAYER ROW ── */
  .admin-player-row { flex-wrap: wrap; gap: 8px; }
  .admin-player-confirm {
    width: 100%;
    justify-content: space-between;
  }
  ...
  /* ── FIXTURE ROW ── */
  .fixture-team { font-size: 11.5px; }
  .fixture-score { font-size: 11.5px; margin: 0 4px; min-width: 46px; padding: 3px 6px; }
  .fixture-status { font-size: 10px; }
...
@media (max-width: 380px) {
  ...
  .group-card-body { gap: 5px; }
  .team-chip { height: 36px; padding: 0 10px; font-size: 12px; }
}
`;
